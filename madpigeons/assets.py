...
LARGE_DAMAGED_STONE_PLANK_1 = STONE_SPRITESHEET.subsurface(pygame.Rect(247, 191, 203, 21))
LARGE_DAMAGED_STONE_PLANK_2 = STONE_SPRITESHEET.subsurface(pygame.Rect(247, 213, 203, 21))
LARGE_DAMAGED_STONE_PLANK_3 = STONE_SPRITESHEET.subsurface(pygame.Rect(247, 235, 203, 21))

#Medium Stone Plank
MEDIUM_STONE_PLANK = STONE_SPRITESHEET.subsurface(pygame.Rect(247, 257, 168, 21))
MEDIUM_DAMAGED_STONE_PLANK_1 = STONE_SPRITESHEET.subsurface(pygame.Rect(247, 279, 168, 21))
MEDIUM_DAMAGED_STONE_PLANK_2 = STONE_SPRITESHEET.subsurface(pygame.Rect(247, 301, 168, 21))
MEDIUM_DAMAGED_STONE_PLANK_3 = STONE_SPRITESHEET.subsurface(pygame.Rect(247, 323, 168, 21))

#Small Stone Plank
SMALL_STONE_PLANK = STONE_SPRITESHEET.subsurface(pygame.Rect(417, 256, 82, 21))
SMALL_DAMAGED_STONE_PLANK_1 = STONE_SPRITESHEET.subsurface(pygame.Rect(247, 345, 82, 21))
SMALL_DAMAGED_STONE_PLANK_2 = STONE_SPRITESHEET.subsurface(pygame.Rect(332, 345, 82, 21))
SMALL_DAMAGED_STONE_PLANK_3 = STONE_SPRITESHEET.subsurface(pygame.Rect(417, 278, 82, 21))

#XSmall Stone Plank
XSMALL_STONE_PLANK = STONE_SPRITESHEET.subsurface(pygame.Rect(417, 256, 82, 21))
XSMALL_DAMAGED_STONE_PLANK_1 = STONE_SPRITESHEET.subsurface(pygame.Rect(247, 345, 82, 21))
XSMALL_DAMAGED_STONE_PLANK_2 = STONE_SPRITESHEET.subsurface(pygame.Rect(332, 345, 82, 21))
XSMALL_DAMAGED_STONE_PLANK_3 = STONE_SPRITESHEET.subsurface(pygame.Rect(417, 279, 82, 21))

#Large Stone Square
LARGE_STONE_SQUARE = STONE_SPRITESHEET.subsurface(pygame.Rect(2, 338, 40, 40))
DAMAGED_LARGE_STONE_SQUARE_1 = STONE_SPRITESHEET.subsurface(pygame.Rect(85, 338, 40, 40))
DAMAGED_LARGE_STONE_SQUARE_2 = STONE_SPRITESHEET.subsurface(pygame.Rect(332, 127, 40, 40))
DAMAGED_LARGE_STONE_SQUARE_3 = STONE_SPRITESHEET.subsurface(pygame.Rect(375, 127, 40, 40))
