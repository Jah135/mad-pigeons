...
GLASS_FRICTION = 0.1
GLASS_DENSITY = 0.9
GLASS_DAMAGE_RESISTANCE = 1.1


class Box(FragileEntity):
    max_health = 30
    damage_resistance = GLASS_DAMAGE_RESISTANCE
    damage_textures = (assets.GLASS_BOX_3, assets.GLASS_BOX_2,
                       assets.GLASS_BOX_1, assets.GLASS_BOX_0)
...
class Wedge(FragileEntity):
    max_health = 30
    damage_resistance = GLASS_DAMAGE_RESISTANCE
    damage_textures = (assets.GLASS_WEDGE_3, assets.GLASS_WEDGE_2,
                       assets.GLASS_WEDGE_1, assets.GLASS_WEDGE_0)
    texture_dimensions = (BOX_WIDTH, BOX_WIDTH)
...
class Triangle(FragileEntity):
    max_health = 30
    damage_resistance = GLASS_DAMAGE_RESISTANCE
    damage_textures = (assets.GLASS_TRIANGLE_3, assets.GLASS_TRIANGLE_2,
                       assets.GLASS_TRIANGLE_1, assets.GLASS_TRIANGLE_0)
    texture_dimensions = (BOX_WIDTH, BOX_WIDTH)
...
class Slab(FragileEntity):
    max_health = 20
    damage_resistance = GLASS_DAMAGE_RESISTANCE
    damage_textures = (assets.GLASS_SLAB_3, assets.GLASS_SLAB_2,
                       assets.GLASS_SLAB_1, assets.GLASS_SLAB_0)
    texture_dimensions = (SLAB_WIDTH, SLAB_WIDTH // SLAB_XY_RATIO)

    def create_body(self) -> pymunk.Body:
        body = pymunk.Body()
        shape = pymunk.Poly(body, polygon.generate_rectangle(
            SLAB_WIDTH, SLAB_XY_RATIO))
        shape.density = GLASS_DENSITY
        shape.friciton = GLASS_FRICTION
        shape.elasticity = GLASS_ELASTICITY
...
class LargePlank(FragileEntity):
    max_health = 30
    damage_resistance = GLASS_DAMAGE_RESISTANCE
    damage_textures = (assets.LARGE_GLASS_PLANK_3, assets.LARGE_GLASS_PLANK_2,
                       assets.LARGE_GLASS_PLANK_1, assets.LARGE_GLASS_PLANK_0)
...
class LargeBall(FragileEntity):
    max_health = 30
    damage_resistance = GLASS_DAMAGE_RESISTANCE
    damage_textures = (assets.LARGE_GLASS_BALL_3, assets.LARGE_GLASS_BALL_2,
                       assets.LARGE_GLASS_BALL_1, assets.LARGE_GLASS_BALL_0)
...
class SmallBall(FragileEntity):
    max_health = 15
    damage_resistance = GLASS_DAMAGE_RESISTANCE
    damage_textures = (assets.SMALL_GLASS_BALL_3, assets.SMALL_GLASS_BALL_2,
                       assets.SMALL_GLASS_BALL_1, assets.SMALL_GLASS_BALL_0)
